...
function Activity() {
  ...
  const { singleActivityId, setSingleActivityId} = useContext(Context)
    ...
    // call api
    const allActivity = [{ "_id": 1,"code":"2024Test","type":"路跑","place":"總統府", "createdAt": "2024-01-18", "clicked": 0, "photo": [test, test0], "title": "新聞360》新聞360》新聞360》新聞360》新聞360》中共選後露真面目！專家曝「這理由」台海局勢惡化機率小", "description": "dshjkhjsdgv" },
