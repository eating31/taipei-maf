...
import CreateModal from '../Component/NewsManage/CreateModal'
import DetailModal from '../Component/NewsManage/DetailModal'
import Finder from '../API/Finder';
import DeleteModal from '../Component/NewsManage/DeleteModal';
import { SnackbarProvider, enqueueSnackbar } from 'notistack';


import { PhotoProvider, PhotoView } from 'react-photo-view';
import 'react-photo-view/dist/react-photo-view.css';
import CreateNewTypeModal from '../Component/NewsManage/CreateNewTypeModal';
import UpdateModal from '../Component/NewsManage/UpdateModal';
...
function NewsManage() {
    ...
    const tempManageAllNews = [{ "_id": 1, "triggerBy": { "username": "emma" }, "type": "活動", "read": "all", "createdAt": "2024-01-18", "updatedAt": "2024-01-18", "clicked": 0, "photo": [], "title": "新聞360》中共選後露真面目！專家曝「這理由」台海局勢惡化機率小", "description": "dshjkhjsdgv" },
                                ...
                                manageAllNews.length > 0 ? manageAllNews.map((each, index) => {
                                    return (
                                        <tr key={each._id} onClick={() => OpenDetailModal(each)}>
                                            ...
                                            <td>{changeDate(each.news_update)}</td>
